...
const Support = () => {
  ...
  // Local states for error handling
  ...
  } = useSelector((state) => state.supportResource);
  ...
  return (
    <div className="min-h-screen bg-blue-50 p-8 max-w-7xl mx-auto">
      ...
      {/* SupportResource */}
      {resourcesError ? (
        <p className="text-red-600 text-center my-4">{resourcesError}</p>
      ) : (
      ...
      {/* Groups */}
      {groupsError ? (
        <p className="text-red-600 text-center my-4">{groupsError}</p>
      ) : (
