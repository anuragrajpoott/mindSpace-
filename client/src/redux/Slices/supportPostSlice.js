...
export const fetchSupportPosts = createAsyncThunk('posts/fetchSupportPosts', async (_, { rejectWithValue }) => {
  try {
...
export const createSupportPost = createAsyncThunk('posts/createSupportPost', async (content, { rejectWithValue }) => {
  try {
...
const postsSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      .addCase(fetchSupportPosts.pending, (state) => { state.loading = true; state.error = null; })
